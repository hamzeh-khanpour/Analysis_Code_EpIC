...
// ============================================
  ...
  TTree *tree_EIC_All;
   ...
   file = TFile::Open("EIC_Hamzeh_Final_New_5M_x_L_Qp100.root");
...
cout << "event_weight_BH =" << event_weight_BH << endl;
  ...
  histMll_TCS->Fill(Mll,event_weight_TCS);
...
cout << "event_weight_TCS =" << event_weight_TCS << endl;
  ...
  histMll_All->Fill(Mll,event_weight_All);
...
histMll_BH->GetYaxis()->SetTitleFont(22);
   ...
   histMll_BH->GetYaxis()->SetRangeUser(0.01,100);
...
c1->SaveAs("Mll_dxs_Qp100_5M.pdf");
//c1->SaveAs("Mll.C");
//c1->SaveAs("Mll.eps");
//c1->SaveAs("Mll.root");
...
c2->SaveAs("Ptll_dxs_Qp100_5M.pdf");
//c2->SaveAs("ptll.C");
//c2->SaveAs("ptll.eps");
//c2->SaveAs("ptll.root");
...
c3->SaveAs("t-value_dxs_Qp100_5M.pdf");
//c3->SaveAs("t-value.C");
...
c4->SaveAs("t-value-nonorm_dxs_Qp100_5M.pdf");
