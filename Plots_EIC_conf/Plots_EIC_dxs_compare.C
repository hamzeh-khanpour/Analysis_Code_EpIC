...
// ============================================
  ...
  TTree *tree_EIC_All;
   ...
   file = TFile::Open("compare09.root");
  ...
  histPtll_BH->Fill(Ptll,event_weight_BH);
...
cout << "event_weight_BH =" << event_weight_BH << endl;
  ...
  histPtll_TCS->Fill(Ptll,event_weight_TCS);
...
cout << "event_weight_TCS =" << event_weight_TCS << endl;
  ...
  histPtll_All->Fill(Ptll,event_weight_All);
...
//leg->AddEntry(histMll_BH,"-0.2<t","L")->SetTextColor(2);
leg->AddEntry(histMll_TCS,"-4.0<t","L")->SetTextColor(6);
leg->AddEntry(histMll_All,"GRAPE","L")->SetTextColor(4);
...
histMll_BH->GetYaxis()->SetTitleFont(22);
   ...
   histMll_BH->GetYaxis()->SetRangeUser(0.0,200);
...
//   histMll_BH->Draw("hist");
   histMll_TCS->Draw("hist");
   histMll_All->Draw("hist same");
   
   
   cout << "-0.2 < t = "  <<  histMll_BH->Integral()/4.0  << endl;
   cout << "-4.0 < t = "  <<  histMll_TCS->Integral()/4.0  << endl;
   cout << " GRAPE   = "  <<  histMll_All->Integral()/4.0  << endl;
...
c1->SaveAs("Mll_dxs_Qp100_5M_compare_09.pdf");
//c1->SaveAs("Mll.C");
//c1->SaveAs("Mll.eps");
//c1->SaveAs("Mll.root");
...
histPtll_BH->GetYaxis()->SetTitleFont(22);
   ...
   histPtll_BH->GetYaxis()->SetRangeUser(0.01,100);
...
c2->SaveAs("Ptll_dxs_Qp100_5M_compare_09.pdf");
//c2->SaveAs("ptll.C");
//c2->SaveAs("ptll.eps");
//c2->SaveAs("ptll.root");
...
c3->SaveAs("t-value_dxs_Qp100_5M_compare_09.pdf");
//c3->SaveAs("t-value.C");
...
c4->SaveAs("t-value-nonorm_dxs_Qp100_5M_compare_09.pdf");
