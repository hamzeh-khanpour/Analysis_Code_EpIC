...
// ============================================
  ...
  TTree *tree_EIC_All;
   ...
   file = TFile::Open("EIC_conf_200K_pol_p_m_merged.root");
...
c3->SaveAs("t-value_conf_200K.pdf");
//c3->SaveAs("t-value.C");
...
c4->SaveAs("t-value-nonorm_conf_200K.pdf");
