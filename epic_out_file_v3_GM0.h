...
// found on file: epic_out_file_v3_GM0.root
//////////////////////////////////////////////////////////

#ifndef epic_out_file_v3_GM0_h
#define epic_out_file_v3_GM0_h
...
//   vector<string>  attribute_string;
   ...
   epic_out_file_v3_GM0(TTree *tree=0);
   virtual ~epic_out_file_v3_GM0();
...
#ifdef epic_out_file_v3_GM0_cxx
epic_out_file_v3_GM0::epic_out_file_v3_GM0(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/epic_out_file_BH_hel_-1_pol001_new_1M_GM0.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/epic_out_file_ALL_hel_-1_pol001_new_1M_GM0.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hamzeh-khanpour/hepmc3-build/epic_out_file_BH_hel_-1_pol001_new_1M_GM0.root");
     //    f = new TFile("/home/hamzeh-khanpour/hepmc3-build/epic_out_file_ALL_hel_-1_pol001_new_1M_GM0.root");
      }
...
epic_out_file_v3_GM0::~epic_out_file_v3_GM0()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t epic_out_file_v3_GM0::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t epic_out_file_v3_GM0::LoadTree(Long64_t entry)
{
...
void epic_out_file_v3_GM0::Init(TTree *tree)
{
...
Bool_t epic_out_file_v3_GM0::Notify()
{
...
void epic_out_file_v3_GM0::Show(Long64_t entry)
{
...
Int_t epic_out_file_v3_GM0::Cut(Long64_t entry)
{
...
#endif // #ifdef epic_out_file_v3_GM0_cxx
