...
#ifndef epic_out_file_h
#define epic_out_file_h
...
//   vector<string>  attribute_string;
   ...
   epic_out_file(TTree *tree=0);
   virtual ~epic_out_file();
...
#ifdef epic_out_file_cxx
epic_out_file::epic_out_file(TTree *tree) : fChain(0) 
{
...
epic_out_file::~epic_out_file()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t epic_out_file::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t epic_out_file::LoadTree(Long64_t entry)
{
...
void epic_out_file::Init(TTree *tree)
{
...
void epic_out_file::Show(Long64_t entry)
{
...
Int_t epic_out_file::Cut(Long64_t entry)
{
