...
// found on file: epic_out_file_v3.root
//////////////////////////////////////////////////////////

#ifndef epic_out_file_v3_h
#define epic_out_file_v3_h
...
//   vector<string>  attribute_string;
   ...
   epic_out_file_v3(TTree *tree=0);
   virtual ~epic_out_file_v3();
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("epic_out_file_BH_hel_-1_pol001_new_1M.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("epic_out_file_TCS_hel_-1_pol001_new_1M.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("epic_out_file_ALL_hel_-1_pol001_new_1M.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("epic_out_file_BH_hel_-1_pol001_new_1M.root");
     //    f = new TFile("epic_out_file_TCS_hel_-1_pol001_new_1M.root");
     //    f = new TFile("epic_out_file_ALL_hel_-1_pol001_new_1M.root");
      }
...
epic_out_file_v3::~epic_out_file_v3()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t epic_out_file_v3::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t epic_out_file_v3::LoadTree(Long64_t entry)
{
...
void epic_out_file_v3::Init(TTree *tree)
{
...
Bool_t epic_out_file_v3::Notify()
{
...
void epic_out_file_v3::Show(Long64_t entry)
{
...
Int_t epic_out_file_v3::Cut(Long64_t entry)
{
...
#endif // #ifdef epic_out_file_v3_cxx
