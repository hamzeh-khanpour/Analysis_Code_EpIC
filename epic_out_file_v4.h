...
// found on file: epic_out_file_v4.root
//////////////////////////////////////////////////////////

#ifndef epic_out_file_v4_h
#define epic_out_file_v4_h
...
//   vector<string>  attribute_string;
   ...
   epic_out_file_v4(TTree *tree=0);
   virtual ~epic_out_file_v4();
...
#ifdef epic_out_file_v4_cxx
epic_out_file_v4::epic_out_file_v4(TTree *tree) : fChain(0) 
{
...
epic_out_file_v4::~epic_out_file_v4()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t epic_out_file_v4::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t epic_out_file_v4::LoadTree(Long64_t entry)
{
...
void epic_out_file_v4::Init(TTree *tree)
{
...
Bool_t epic_out_file_v4::Notify()
{
...
void epic_out_file_v4::Show(Long64_t entry)
{
...
Int_t epic_out_file_v4::Cut(Long64_t entry)
{
...
#endif // #ifdef epic_out_file_v4_cxx
