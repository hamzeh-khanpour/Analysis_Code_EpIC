...
void Plots_EIC_HMLM(){
   ...
   Float_t  integrated_cross_section_value_LM  = 3.254113737442850   * 1000.0;   //   nb   BH LM
   Float_t  integrated_cross_section_value_HM = 0.214955831103257   * 1000.0;   //    nb   BH HM
...
// ============================================
   ...
   file = TFile::Open("EIC_BH_tagged.root");
