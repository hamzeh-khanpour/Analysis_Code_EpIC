...
// Mon Aug  7 11:58:35 2023 by ROOT version 6.24/06
// from TTree hepmc3_tree/hepmc3_tree
// found on file: epic_out_file_v3_HM.root
//////////////////////////////////////////////////////////

#ifndef epic_out_file_v3_HM_h
#define epic_out_file_v3_HM_h
...
//   vector<string>  attribute_string;
   ...
   epic_out_file_v3_HM(TTree *tree=0);
   virtual ~epic_out_file_v3_HM();
...
#ifdef epic_out_file_v3_HM_cxx
epic_out_file_v3_HM::epic_out_file_v3_HM(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/New_Samples_October_tagged_Qprime1000_BH.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/New_Samples_October_tagged_Qprime10_BH.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/New_Samples_October_tagged_Qprime10_TCS.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hamzeh-khanpour/hepmc3-build/New_Samples_October_tagged_Qprime1000_BH.root");
     //    f = new TFile("/home/hamzeh-khanpour/hepmc3-build/New_Samples_October_tagged_Qprime10_BH.root");
     //    f = new TFile("/home/hamzeh-khanpour/hepmc3-build/New_Samples_October_tagged_Qprime10_TCS.root");
      }
...
epic_out_file_v3_HM::~epic_out_file_v3_HM()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t epic_out_file_v3_HM::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t epic_out_file_v3_HM::LoadTree(Long64_t entry)
{
...
void epic_out_file_v3_HM::Init(TTree *tree)
{
...
Bool_t epic_out_file_v3_HM::Notify()
{
...
void epic_out_file_v3_HM::Show(Long64_t entry)
{
...
Int_t epic_out_file_v3_HM::Cut(Long64_t entry)
{
...
#endif // #ifdef epic_out_file_v3_HM_cxx
