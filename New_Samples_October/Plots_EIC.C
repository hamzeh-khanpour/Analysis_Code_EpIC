...
void Plots_EIC(){
   ...
   Float_t  integrated_cross_section_value_BH  = 3.25411373744285   * 1000.0;   //   nb   BH
   Float_t  integrated_cross_section_value_TCS = 0.00207616922322   * 1000.0;   //   nb   TCS
   Float_t  integrated_cross_section_value_All = 2.99634713070550   * 1000.0;   //   nb   BH+TCS
