...
void Plots_EIC_tagged_Final_GM0(){
   ...
   Float_t  integrated_cross_section_value_LM_BH_GM0  = 2.91992877274969   * 1000.0;   //    nb   BH_GM0 LM
   Float_t  integrated_cross_section_value_HM_BH_GM0  = 0.18010878147768   * 1000.0;   //    nb   BH_GM0 HM
