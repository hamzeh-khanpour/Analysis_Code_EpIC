...
#define epic_out_file_v3_HM_cxx
#include "epic_out_file_v3_HM.h"
...
TFile *target;
TTree *Tsignal_EIC = new TTree("EIC_BH_HM","EIC_BH_HM");
TFile *F;
...
void epic_out_file_v3_HM::Loop()
{
//   In a ROOT session, you can do:
//      root> .L epic_out_file_v3_HM.C
//      root> epic_out_file_v3_HM t
...
//      Float_t  integrated_cross_section_value_BH  = 3.25411373744285   * 1000.0;   //   nb   BH       LM *
//      Float_t  integrated_cross_section_value_TCS = 0.00207616922322   * 1000.0;   //   nb   TCS      LM *
//      Float_t  integrated_cross_section_value_All = 2.99634713070550   * 1000.0;   //   nb   BH+TCS   LM *

      Float_t  integrated_cross_section_value_BH  = 0.214955831103257   * 1000.0;   //   nb   BH              HM *
      Float_t  integrated_cross_section_value_TCS = 5.0480786184382/100000.0   * 1000.0;   //   nb   TCS      HM *
      Float_t  integrated_cross_section_value_All = 0.200407476242377   * 1000.0;   //   nb   BH+TCS          HM *
...
//      cout << "phil    = "  << phil     << endl;
     ...
     target = new TFile ("EIC_BH_tagged_HM.root","recreate");
     target->cd();
...
TLatex *t5a = new TLatex(0.666,0.66,"#gamma-tagged (high-mass sample)");
                t5a->SetNDC();
                t5a->SetTextFont(12);
...
c1->SaveAs("Massdilepton_tagged_Qprime10_HM.pdf");
//c1->SaveAs("Massdilepton_tagged_Qprime10.C");
//c1->SaveAs("Massdilepton_tagged_Qprime10.eps");
//c1->SaveAs("Massdilepton_tagged_Qprime10.root");
//c1->SaveAs("Massdilepton_tagged_Qprime10.jpg");
...
c2->SaveAs("Ptdilepton_tagged_Qprime10_HM.pdf");
//c2->SaveAs("Ptdilepton_tagged_Qprime10.C");
//c2->SaveAs("Ptdilepton_tagged_Qprime10.eps");
//c2->SaveAs("Ptdilepton_tagged_Qprime10.root");
//c2->SaveAs("Ptdilepton_tagged_Qprime10.jpg");
...
c3->SaveAs("t_value_tagged_Qprime10_HM.pdf");
//c3->SaveAs("tvalue_tagged_Qprime10.C");
//c3->SaveAs("tvalue_tagged_Qprime10.eps");
//c3->SaveAs("tvalue_tagged_Qprime10.root");
//c3->SaveAs("tvalue_tagged_Qprime10.jpg");
...
c4->SaveAs("thetal_tagged_Qprime10_HM.pdf");
//c4->SaveAs("thetal_tagged_Qprime10.C");
//c4->SaveAs("thetal_tagged_Qprime10.eps");
//c4->SaveAs("thetal_tagged_Qprime10.root");
//c4->SaveAs("thetal_tagged_Qprime10.jpg");
...
c5->SaveAs("phil_tagged_Qprime10_HM.pdf");
//c5->SaveAs("phil_tagged_Qprime10.C");
//c5->SaveAs("phil_tagged_Qprime10.eps");
//c5->SaveAs("phil_tagged_Qprime10.root");
//c5->SaveAs("phil_tagged_Qprime10.jpg");
...
c6->SaveAs("epT_tagged_Qprime10_HM.pdf");
//c6->SaveAs("epT_tagged_Qprime10.C");
//c6->SaveAs("epT_tagged_Qprime10.eps");
//c6->SaveAs("epT_tagged_Qprime10.root");
//c6->SaveAs("epT_tagged_Qprime10.jpg");





} // The end of main program epic_out_file_v3_HM
