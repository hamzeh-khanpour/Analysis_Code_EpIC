...
void Plots_EIC_HMLM_TCS(){
   ...
   Float_t  integrated_cross_section_value_LM  = 0.00207616922322869   * 1000.0;   //    nb   TCS LM
   Float_t  integrated_cross_section_value_HM  = 5.0480786184382e-05   * 1000.0;   //    nb   TCS HM
...
// ============================================
   ...
   file = TFile::Open("EIC_TCS_tagged.root");
