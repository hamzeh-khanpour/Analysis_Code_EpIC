...
// found on file: epic_out_file_v2.root
//////////////////////////////////////////////////////////

#ifndef epic_out_file_v2_h
#define epic_out_file_v2_h
...
//   vector<string>  attribute_string;
   ...
   epic_out_file_v2(TTree *tree=0);
   virtual ~epic_out_file_v2();
...
#ifdef epic_out_file_v2_cxx
epic_out_file_v2::epic_out_file_v2(TTree *tree) : fChain(0) 
{
...
epic_out_file_v2::~epic_out_file_v2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t epic_out_file_v2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t epic_out_file_v2::LoadTree(Long64_t entry)
{
...
void epic_out_file_v2::Init(TTree *tree)
{
...
Bool_t epic_out_file_v2::Notify()
{
...
void epic_out_file_v2::Show(Long64_t entry)
{
...
Int_t epic_out_file_v2::Cut(Long64_t entry)
{
...
#endif // #ifdef epic_out_file_v2_cxx
