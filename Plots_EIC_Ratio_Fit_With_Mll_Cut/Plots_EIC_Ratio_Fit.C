...
// ============================================
  ...
  TTree *tree_EIC_All;
   ...
   file = TFile::Open("EIC_Hamzeh_Final_New_5M_x_L_Qp100_Mll_3.root");
...
TLatex *t6b = new TLatex(0.65,0.40,"y = ax + b;      M^{#mu^{+}#mu^{-}} > 3 GeV");
                t6b->SetNDC();
                t6b->SetTextFont(12);
...
TLatex *t7b = new TLatex(0.60,0.35,"a= 0.12022#pm0.25540,  b= 1.04002#pm0.01810");
                t7b->SetNDC();
                t7b->SetTextFont(12);
...
c4->SaveAs("Ratio_All_to_BH_Fit_Qp100_5M_Mll_3GeV.pdf");
