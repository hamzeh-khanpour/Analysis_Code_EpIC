...
void Plots_EIC_BH(){
   ...
   Float_t  integrated_cross_section_value_All = 0.5*(18.846817263905+18.9618532554946)   * 1000.0;  
...
c1->SaveAs("Mll_conf_09_Final.pdf");
//c1->SaveAs("Mll.C");
//c1->SaveAs("Mll.eps");
//c1->SaveAs("Mll.root");
...
c2->SaveAs("Ptll_conf_09_Final.pdf");
//c2->SaveAs("ptll.C");
//c2->SaveAs("ptll.eps");
//c2->SaveAs("ptll.root");
...
//c3->SaveAs("t-value_conf_099_Final.pdf");
//c3->SaveAs("t-value.C");
