...
void Plots_EIC_Theta_L(){

    
    
   Float_t  nentries = 2000000.0;
   Float_t  integrated_luminosity = 300.0 / 1000.0; // fb^{-1} 
   Float_t  integrated_cross_section_value_BH  = 18.3193959671398   * 1000.0;   //   nb   BH
   Float_t  integrated_cross_section_value_TCS = 0.00828581417582967 * 1000.0;   //   nb   TCS   
   Float_t  integrated_cross_section_value_All = 0.5*(18.846817263905+18.9618532554946)   * 1000.0;   //   nb   BH+TCS  
...
TLatex *t7b = new TLatex(0.60,0.35,"a= 0.196379#pm0.156268,  b= 1.01482#pm0.00985741");
                t7b->SetNDC();
                t7b->SetTextFont(12);
...
c4->SaveAs("Ratio_All_to_BH_Fit_conf_099.pdf");
