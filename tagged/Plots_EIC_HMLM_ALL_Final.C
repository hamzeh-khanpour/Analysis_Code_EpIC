...
leg6->AddEntry(resultHist_etal,"ALL (LM+HM)","L")->SetTextColor(2);
...
canvasetal->Update();
//delete canvas;
canvasetal->SaveAs("etal_tagged_LM_HM_ALL.pdf");
...
leg7->AddEntry(resultHist_q2,"ALL (LM+HM)","L")->SetTextColor(2);
...
canvasq2->Update();
//delete canvas;
canvasq2->SaveAs("q2_tagged_LM_HM_ALL.pdf");
...
leg8->AddEntry(resultHist_q2prime,"ALL (LM+HM)","L")->SetTextColor(2);
...
//delete canvas;
canvasq2prime->SaveAs("q2prime_tagged_LM_HM_ALL.pdf");
