...
void Plots_EIC_HMLM_TCS_Final(){

    
   
   Float_t  nentries = 5000000.0;
   Float_t  integrated_luminosity = 300.0 / 1000.0; // fb^{-1} 
   Float_t  integrated_cross_section_value_LM  = 0.00207609     * 1000.0;   //    nb   TCS LM
   Float_t  integrated_cross_section_value_HM  = 0.0000504905   * 1000.0;   //    nb   TCS HM
...
TH1 *histetal_LM         =  new TH1F("etal", "",    30, -3.0, 3.0);
TH1 *histetal_HM         =  new TH1F("etal", "",    30, -3.0, 3.0);


TH1 *histq2_LM           =  new TH1F("q2", "",      30, 0.0, 0.01);
TH1 *histq2_HM           =  new TH1F("q2", "",      30, 0.0, 0.01);


TH1 *histq2prime_LM      =  new TH1F("q2prime", "", 30, 1.0, 1000.0);
TH1 *histq2prime_HM      =  new TH1F("q2prime", "", 30, 1.0, 1000.0);
...
// ============================================
   ...
   tree_EIC_LM  = (TTree*)file->Get("EIC_TCS_LM");
   tree_EIC_HM = (TTree*)file->Get("EIC_TCS_HM");
   ...
   tree_EIC_LM->SetBranchAddress("etal",&etal);
   tree_EIC_HM->SetBranchAddress("etal",&etal);

   tree_EIC_LM->SetBranchAddress("q2",&q2);
   tree_EIC_HM->SetBranchAddress("q2",&q2);

   tree_EIC_LM->SetBranchAddress("q2prime",&q2prime);
   tree_EIC_HM->SetBranchAddress("q2prime",&q2prime);
...
//cout << "event_weight_LM =" << event_weight_LM << endl;
  ...
  histetal_LM->Fill(etal,event_weight_LM/(6.0/30.0));
  histq2_LM->Fill(q2,event_weight_LM/(0.01/30.0));
  histq2prime_LM->Fill(q2prime,event_weight_LM/(1000.0/30.0));
...
//cout << "event_weight_HM =" << event_weight_HM << endl;
  ...
  histetal_HM->Fill(etal,event_weight_HM/(6.0/30.0));
  histq2_HM->Fill(q2,event_weight_HM/(0.01/30.0));
  histq2prime_HM->Fill(q2prime,event_weight_HM/(1000.0/30.0));
...
leg->AddEntry(histMll_LM,"TCS LM","L")->SetTextColor(2);
leg->AddEntry(histMll_HM,"TCS HM","L")->SetTextColor(6);
...
leg2->AddEntry(resultHist_Mll,"TCS (LM+HM)","L")->SetTextColor(2);
...
canvasMll->Update();
//delete canvas;
canvasMll->SaveAs("Mll_tagged_LM_HM_TCS.pdf");
...
leg3->AddEntry(resultHist_Ptll,"TCS (LM+HM)","L")->SetTextColor(2);
...
canvasPtll->Update();
//delete canvas;
canvasPtll->SaveAs("Ptll_tagged_LM_HM_TCS.pdf");
...
leg4->AddEntry(resultHist_tvalue,"TCS (LM+HM)","L")->SetTextColor(2);
...
canvastvalue->Update();
//delete canvas;
canvastvalue->SaveAs("t_value_tagged_LM_HM_TCS.pdf");
...
leg5->AddEntry(resultHist_thetal,"TCS (LM+HM)","L")->SetTextColor(2);
...
canvasthetal->Update();
//delete canvas;
canvasthetal->SaveAs("thetal_tagged_LM_HM_TCS.pdf");
...
//histetal_LM->SetTitle("Jet Algorithem = ee_genkt_cambridge"); t5a->Draw("same");
histetal_LM->GetXaxis()->SetTitle("#eta^{l}");
//histetal_LM->GetXaxis()->SetTitleOffset(1.25);
histetal_LM->GetXaxis()->SetLabelFont(22);
histetal_LM->GetXaxis()->SetTitleFont(22);
histetal_LM->GetYaxis()->SetTitle("d#sigma/d#eta^{l}");
histetal_LM->GetYaxis()->SetTitleOffset(1.40);
histetal_LM->GetYaxis()->SetLabelFont(22);
histetal_LM->GetYaxis()->SetTitleFont(22);

histetal_LM->GetYaxis()->SetRangeUser(0.1,100);


 cout<<"Integral(etal) ="<<histetal_LM->Integral()<<endl;

   histetal_LM->SetLineWidth(3);
   histetal_HM->SetLineWidth(3);

   histetal_LM->SetLineColor(2);
   histetal_HM->SetLineColor(6);

   histetal_LM->Draw("hist");
   histetal_HM->Draw("hist same");
...
//c7->SaveAs("etal_tagged_Qprime10_Compare.pdf");
//c7->SaveAs("etal_tagged_Qprime10_Compare.C");
//c7->SaveAs("etal_tagged_Qprime10_Compare.eps");
//c7->SaveAs("etal_tagged_Qprime10_Compare.root");
//c7->SaveAs("etal_tagged_Qprime10_Compare.jpg");
...
TCanvas *canvasetal = new TCanvas("canvasetal", "Histogram Sum", 10, 10, 900, 700);
TH1F *resultHist_etal = (TH1F*)histetal_LM->Clone(); // Clone histtvalue_LM to keep the original histogram
resultHist_etal->Add(histetal_HM);


Double_t xl11=0.70, yl11=0.70, xl12=xl11+0.150, yl12=yl11+0.150;

TLegend *leg6 = new TLegend(xl11,yl11,xl12,yl12);
leg6->SetBorderSize(0);

leg6->AddEntry(resultHist_etal,"TCS (LM+HM)","L")->SetTextColor(2);

leg6->SetTextSize(0.032);
leg6->SetTextFont(12);
leg6->SetFillStyle(0);


resultHist_etal->GetXaxis()->SetTitle("#eta^{l}");
resultHist_etal->GetXaxis()->SetTitleOffset(1.25);
resultHist_etal->GetXaxis()->SetLabelFont(22);
resultHist_etal->GetXaxis()->SetTitleFont(22);
resultHist_etal->GetYaxis()->SetTitle("d#sigma/d#eta^{l}");
resultHist_etal->GetYaxis()->SetTitleOffset(1.40);
resultHist_etal->GetYaxis()->SetLabelFont(22);
resultHist_etal->GetYaxis()->SetTitleFont(22);

resultHist_etal->Draw("hist");


cout << "Integral resultHist_etal = "  <<  resultHist_etal->Integral()/4.0 << endl;


 canvasetal->SetLogy(1);
...
canvasetal->Update();
//delete canvas;
canvasetal->SaveAs("etal_tagged_LM_HM_TCS.pdf");
...
//histq2_LM->SetTitle("Jet Algorithem = ee_genkt_cambridge"); t5a->Draw("same");
histq2_LM->GetXaxis()->SetTitle("q^{2}");
//histq2_LM->GetXaxis()->SetTitleOffset(1.25);
histq2_LM->GetXaxis()->SetLabelFont(22);
histq2_LM->GetXaxis()->SetTitleFont(22);
histq2_LM->GetYaxis()->SetTitle("d#sigma/dq^{2}");
histq2_LM->GetYaxis()->SetTitleOffset(1.40);
histq2_LM->GetYaxis()->SetLabelFont(22);
histq2_LM->GetYaxis()->SetTitleFont(22);

//histq2_LM->GetYaxis()->SetRangeUser(0.1,100);


 cout<<"Integral(q2) ="<<histq2_LM->Integral()<<endl;

   histq2_LM->SetLineWidth(3);
   histq2_HM->SetLineWidth(3);

   histq2_LM->SetLineColor(2);
   histq2_HM->SetLineColor(6);

   histq2_LM->Draw("hist");
   histq2_HM->Draw("hist same");
...
//c8->SaveAs("q2_tagged_Qprime10_Compare.pdf");
//c8->SaveAs("q2_tagged_Qprime10_Compare.C");
//c8->SaveAs("q2_tagged_Qprime10_Compare.eps");
//c8->SaveAs("q2_tagged_Qprime10_Compare.root");
//c8->SaveAs("q2_tagged_Qprime10_Compare.jpg");
...
TCanvas *canvasq2 = new TCanvas("canvasq2", "Histogram Sum", 10, 10, 900, 700);
TH1F *resultHist_q2 = (TH1F*)histq2_LM->Clone(); // Clone histtvalue_LM to keep the original histogram
resultHist_q2->Add(histq2_HM);


Double_t xl13=0.70, yl13=0.70, xl14=xl13+0.150, yl14=yl13+0.150;

TLegend *leg7 = new TLegend(xl13,yl13,xl14,yl14);
leg7->SetBorderSize(0);

leg7->AddEntry(resultHist_q2,"TCS (LM+HM)","L")->SetTextColor(2);
...
resultHist_q2->GetXaxis()->SetTitle("q^{2}");
resultHist_q2->GetXaxis()->SetTitleOffset(1.25);
resultHist_q2->GetXaxis()->SetLabelFont(22);
resultHist_q2->GetXaxis()->SetTitleFont(22);
resultHist_q2->GetYaxis()->SetTitle("d#sigma/dq^{2}");
resultHist_q2->GetYaxis()->SetTitleOffset(1.40);
resultHist_q2->GetYaxis()->SetLabelFont(22);
resultHist_q2->GetYaxis()->SetTitleFont(22);

resultHist_q2->Draw("hist");


cout << "Integral resultHist_q^{2} = "  <<  resultHist_q2->Integral()/4.0 << endl;
...
canvasq2->Update();
//delete canvas;
canvasq2->SaveAs("q2_tagged_LM_HM_TCS.pdf");
...
//histq2prime_LM->SetTitle("Jet Algorithem = ee_genkt_cambridge"); t5a->Draw("same");
histq2prime_LM->GetXaxis()->SetTitle("Q^{'2}");
//histq2prime_LM->GetXaxis()->SetTitleOffset(1.25);
histq2prime_LM->GetXaxis()->SetLabelFont(22);
histq2prime_LM->GetXaxis()->SetTitleFont(22);
histq2prime_LM->GetYaxis()->SetTitle("d#sigma/dQ^{'2}");
histq2prime_LM->GetYaxis()->SetTitleOffset(1.40);
histq2prime_LM->GetYaxis()->SetLabelFont(22);
histq2prime_LM->GetYaxis()->SetTitleFont(22);

//histq2prime_LM->GetYaxis()->SetRangeUser(0.1,100);


 cout<<"Integral(q2prime) ="<<histq2prime_LM->Integral()<<endl;

   histq2prime_LM->SetLineWidth(3);
   histq2prime_HM->SetLineWidth(3);

   histq2prime_LM->SetLineColor(2);
   histq2prime_HM->SetLineColor(6);

   histq2prime_LM->Draw("hist");
   histq2prime_HM->Draw("hist same");
...
//c9->SaveAs("q2prime_tagged_Qprime10_Compare.pdf");
//c9->SaveAs("q2prime_tagged_Qprime10_Compare.C");
//c9->SaveAs("q2prime_tagged_Qprime10_Compare.eps");
//c9->SaveAs("q2prime_tagged_Qprime10_Compare.root");
//c9->SaveAs("q2prime_tagged_Qprime10_Compare.jpg");
...
TCanvas *canvasq2prime = new TCanvas("canvasq2prime", "Histogram Sum", 10, 10, 900, 700);
TH1F *resultHist_q2prime = (TH1F*)histq2prime_LM->Clone(); // Clone histtvalue_LM to keep the original histogram
resultHist_q2prime->Add(histq2prime_HM);


Double_t xl15=0.70, yl15=0.70, xl16=xl15+0.150, yl16=yl15+0.150;

TLegend *leg8 = new TLegend(xl15,yl15,xl16,yl16);
leg8->SetBorderSize(0);

leg8->AddEntry(resultHist_q2prime,"TCS (LM+HM)","L")->SetTextColor(2);
...
resultHist_q2prime->GetXaxis()->SetTitle("Q^{'2}");
resultHist_q2prime->GetXaxis()->SetTitleOffset(1.25);
resultHist_q2prime->GetXaxis()->SetLabelFont(22);
resultHist_q2prime->GetXaxis()->SetTitleFont(22);
resultHist_q2prime->GetYaxis()->SetTitle("d#sigma/dQ^{'2}");
resultHist_q2prime->GetYaxis()->SetTitleOffset(1.40);
resultHist_q2prime->GetYaxis()->SetLabelFont(22);
resultHist_q2prime->GetYaxis()->SetTitleFont(22);

resultHist_q2prime->Draw("hist");


cout << "Integral resultHist_q^{'2} = "  <<  resultHist_q2prime->Integral()/4.0 << endl;


 canvasq2prime->SetLogy(1);
...
canvasq2prime->Update();
//delete canvas;
canvasq2prime->SaveAs("q2prime_tagged_LM_HM_TCS.pdf");
