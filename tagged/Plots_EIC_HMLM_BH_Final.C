...
void Plots_EIC_HMLM_BH_Final(){

    
   
   Float_t  nentries = 5000000.0;
   Float_t  integrated_luminosity = 300.0 / 1000.0; // fb^{-1} 
   Float_t  integrated_cross_section_value_LM  = 3.355      * 1000.0;   //   nb   BH LM
   Float_t  integrated_cross_section_value_HM  = 0.219293   * 1000.0;   //    nb   BH HM
...
// ============================================
   ...
   tree_EIC_LM  = (TTree*)file->Get("EIC_BH_LM");
   tree_EIC_HM = (TTree*)file->Get("EIC_BH_HM");
...
leg->AddEntry(histMll_LM,"BH LM","L")->SetTextColor(2);
leg->AddEntry(histMll_HM,"BH HM","L")->SetTextColor(6);
...
leg2->AddEntry(resultHist_Mll,"BH (LM+HM)","L")->SetTextColor(2);
...
leg3->AddEntry(resultHist_Ptll,"BH (LM+HM)","L")->SetTextColor(2);
...
leg4->AddEntry(resultHist_tvalue,"BH (LM+HM)","L")->SetTextColor(2);
...
leg6->AddEntry(resultHist_etal,"BH (LM+HM)","L")->SetTextColor(2);
...
canvasetal->Update();
//delete canvas;
canvasetal->SaveAs("etal_tagged_LM_HM_BH.pdf");
...
leg7->AddEntry(resultHist_q2,"BH (LM+HM)","L")->SetTextColor(2);
...
canvasq2->Update();
//delete canvas;
canvasq2->SaveAs("q2_tagged_LM_HM_BH.pdf");
...
leg8->AddEntry(resultHist_q2prime,"BH (LM+HM)","L")->SetTextColor(2);
...
//delete canvas;
canvasq2prime->SaveAs("q2prime_tagged_LM_HM_BH.pdf");
