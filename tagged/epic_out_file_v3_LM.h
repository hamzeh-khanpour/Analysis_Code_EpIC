...
// found on file: epic_out_file_v3_LM.root
//////////////////////////////////////////////////////////

#ifndef epic_out_file_v3_LM_h
#define epic_out_file_v3_LM_h
...
//   vector<string>  attribute_string;
   ...
   epic_out_file_v3_LM(TTree *tree=0);
   virtual ~epic_out_file_v3_LM();
...
#ifdef epic_out_file_v3_LM_cxx
epic_out_file_v3_LM::epic_out_file_v3_LM(TTree *tree) : fChain(0)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/tagged_Qprime10_BH_5M.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/tagged_Qprime10_TCS_5M.root");
     // TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hamzeh-khanpour/hepmc3-build/tagged_Qprime10_ALL_5M.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hamzeh-khanpour/hepmc3-build/tagged_Qprime10_BH_5M.root");
     //    f = new TFile("/home/hamzeh-khanpour/hepmc3-build/tagged_Qprime10_TCS_5M.root");
     //    f = new TFile("/home/hamzeh-khanpour/hepmc3-build/tagged_Qprime10_ALL_5M.root");
      }
...
epic_out_file_v3_LM::~epic_out_file_v3_LM()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t epic_out_file_v3_LM::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t epic_out_file_v3_LM::LoadTree(Long64_t entry)
{
...
void epic_out_file_v3_LM::Init(TTree *tree)
{
...
Bool_t epic_out_file_v3_LM::Notify()
{
...
void epic_out_file_v3_LM::Show(Long64_t entry)
{
...
Int_t epic_out_file_v3_LM::Cut(Long64_t entry)
{
...
#endif // #ifdef epic_out_file_v3_LM_cxx
